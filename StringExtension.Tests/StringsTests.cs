...
namespace StringExtension.Tests
{
    public class StringConverterTests
    {
        ...
        [TestCase("abcdefghijklmnopqurstuvwxyz", int.MaxValue, ExpectedResult = "acegikmoqrtvxzbdfhjlnpusuwy")]
        ...
        [Test]
        public void Convert_SeparatorString_ArgumentException()
            => Assert.Throws<ArgumentException>(
                () => StringConverter.Convert("     ", int.MaxValue));

        [Test]
        public void Convert_ControlString_ArgumentException()
            => Assert.Throws<ArgumentException>(
                () => StringConverter.Convert("\t\n\a\b\0\v\f", int.MaxValue));
